...
function Setsidebar(props) {
  ...
  return (
    <div
      ...
      <div
        className={`w-10/12 px-4 py-8 h-full sm:w-3/5 md:w-1/3 bg-slate-800 shadow-md shadow-slate-500`}>
        <div className="">
          <img
        ...
        <div className=" py-4">
        <Link to={"/setting"}>
          <div className=" flex gap-1 items-center text-lg hover:bg-slate-700 p-2 rounded text-white">
            <div className="">
